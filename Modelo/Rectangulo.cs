...
{
    internal class Rectangulo : Cuadrilateros
    {
        public Rectangulo(int[] infIzq, int[] supIzq, int[] infDer, int[] supDer) : base(infIzq, supIzq, infDer, supDer)
        {
        }

        public override double Area(int[] infIzq, int[] supIzq, int[] infDer, int[] supDer) // : base(infIzq, supIzq, infDer, supDer)
        {
